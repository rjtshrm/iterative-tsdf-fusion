...
import h5py
import argparse
from dependencies.pyrender import pyrender
from dependencies.pyrender.utils import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", type=str, required=True, help="Input off file")
    parser.add_argument("--out_path", type=str, required=True, help="Output save path")
    parser.add_argument("--n_views", type=int, required=True, help="Number of views")

    args = parser.parse_args()
    render(args.in_file, args.out_path, args.n_views)
